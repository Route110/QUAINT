...
FirstStep.create(:hobby_id => '1',:introduction => 'hello',:item => 'ball',:cost => '1000')
FirstStep.create(:hobby_id => '2',:introduction => 'hello',:item => 'ball',:cost => '1000')
FirstStep.create(:hobby_id => '3',:introduction => 'hello',:item => 'ball',:cost => '1000')
FirstStep.create(:hobby_id => '4',:introduction => 'hello',:item => 'ball',:cost => '1000')